...
const NAV_GROUPS: readonly NavGroupDef[] = [
  {
    ...
    items: [
      ...
      { id: 'events', href: '/events', label: 'Evento', icon: 'events', match: 'events' },
  ...
  },
  {
    ...
    label: 'Equipo',
    items: [
      { id: 'staff', href: '/staff', label: 'Personal', icon: 'team' },
      { id: 'organization', href: '/settings/organization', label: 'Organización', icon: 'user' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'payments', href: '/settings/payments', label: 'Pagos', icon: 'payments' },
    ],
  },
];
