...
import { activitySparkline, classifyKey, keyHealthMeta } from '../_lib/keys';
...
export function KeyDetailDrawer({
  ...
  return (
    <Drawer
      ...
      onClose={onClose}
      title={keyRow.name}
      description={`Prefijo ${keyRow.keyPrefix}… · el secreto nunca se vuelve a mostrar`}
      size="md"
      footer={
        canMutate ? (
    ...
    >
      <div className={styles.drawerBody}>
        ...
        <dl className={styles.metaList}>
          ...
          <div>
            <dt>Último uso</dt>
            <dd>{keyRow.lastUsedAt ? formatDateTime(keyRow.lastUsedAt) : 'Nunca'}</dd>
          </div>
          <div>
            <dt>Caducidad</dt>
            <dd>
        ...
        <section aria-label="Señal de uso estimada">
